...
<body>
    {{-- navbar --}}
    <section>
        <nav class="navbar navbar-expand-lg" style="background-color:seashell">
            <div class="container">
                <a class="navbar-brand" href="{{ url("/") }}">
                    <img src="{{ asset('assets/images/logo.png')}}" alt="Logo" width="25" height="25" class="d-inline-block align-text-top">
      Flowerizt</a>
