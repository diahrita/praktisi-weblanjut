...
@section('content')
    <section class="my-0" style="background-color:seashell">
        <div class="bg-img" style="background-image:url({{url('assets/images/2.jpeg')}})">
                        ...
                        <div class="card bg-light border-warning" style="border-radius: 20px">
                            <div class="card-body">
                                <div class="text-center mb-4">
                                    <img src="{{ asset('assets/images/logo.png') }}" class="img-fluid mb-2" width="70">
                                ...
                                <form method="POST" action="{{ url('user/process-register') }}">
                                    ...
                                    <div class="d-grid gap-2 mt-4 mb-1">
                                        <p class="mb-0">Already have an account?<a href="{{ url('user/login') }}" class="btn btn-link">Login</a>
                                        </p>
                                    </div>
                                </form>
                            </div>
